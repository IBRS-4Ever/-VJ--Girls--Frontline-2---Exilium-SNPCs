...
VJ.AddNPCWeapon("UMP40", "weapon_vj_gf2_ump40", vCat)
...
VJ.AddNPCWeapon("#vj_gf2_snpcs.weapon_blade", "weapon_vj_gf2_blade", vCat)
VJ.AddNPCWeapon("#vj_gf2_snpcs.weapon_feathered_edge", "weapon_vj_gf2_feathered_edge", vCat)
