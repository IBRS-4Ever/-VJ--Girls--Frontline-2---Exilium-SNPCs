...
SWEP.PrintName = "#weapon_vj_gf2_qbz191"
SWEP.Category = "GF2"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound = "GF2_SNPC.Weapon_QBZ191.Shot"
SWEP.Primary.DistantSound = "GF2_SNPC.Weapon_QBZ191.Shot_Dist"
SWEP.PrimaryEffects_MuzzleAttachment = "muzzle"
SWEP.PrimaryEffects_ShellAttachment = "ejectbrass"
SWEP.PrimaryEffects_ShellType = "RifleShellEject"

SWEP.MagazineModel = "models/prop/gfl2_qiongjiu_qbz_191_magazine.mdl"
...
sound.Add({
	name = "GF2_SNPC.Weapon_QBZ191.Shot_Dist",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 140,
	pitch = {90, 110},
