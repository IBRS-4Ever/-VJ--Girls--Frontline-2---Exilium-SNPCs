...
SWEP.PrintName = "#weapon_vj_gf2_spas12"
SWEP.Category = "GF2"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound = "GF2_SNPC.Weapon_SPAS12.Shot"
SWEP.Primary.DistantSound = "GF2_SNPC.Weapon_SPAS12.Shot_Dist"
...
sound.Add({
	name = "GF2_SNPC.Weapon_SPAS12.Shot_Dist",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 140,
	pitch = {90, 110},
