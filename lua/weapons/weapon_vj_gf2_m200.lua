...
SWEP.PrintName = "#weapon_vj_gf2_m200"
SWEP.Category = "GF2"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel = "models/prop/gfl2_cheyanne_m200.mdl"
...
SWEP.MagazineModel = "models/prop/gfl2_cheyanne_m200_magazine.mdl"

sound.Add({
	name = "GF2_SNPC.Weapon_M200.Shot",
	channel = CHAN_WEAPON,
	volume = 1.0,
	level = 80,
	pitch = {90, 110},
...
sound.Add({
	name = "GF2_SNPC.Weapon_M200.Shot_Dist",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 140,
	pitch = {90, 110},
