...
SWEP.PrintName = "#weapon_vj_gf2_ots14_3a"
SWEP.Category = "GF2"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel = "models/weapons/w_ots-14_ots14_3a.mdl"
...
SWEP.NPC_SecondaryFireChance = 4
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage = GetConVarNumber("vj_gf2_ots14_3a_d")
SWEP.Primary.Force = 1
SWEP.Primary.ClipSize = 30
SWEP.Primary.Ammo = "SMG1"
SWEP.NPC_CustomSpread = 0.3
SWEP.Primary.Sound = "GF2_SNPC.Weapon_OTs14_3A.Shot"
SWEP.Primary.DistantSound = "GF2_SNPC.Weapon_OTs14_3A.Shot_Dist"
...
SWEP.MagazineModel = "models/prop/gfl2_ots-14_ots14_gun_magazine.mdl"

sound.Add({
	name = "GF2_SNPC.Weapon_OTs14_3A.Shot",
	channel = CHAN_WEAPON,
	volume = 1.0,
	level = 80,
	pitch = {90, 110},
...
sound.Add({
	name = "GF2_SNPC.Weapon_OTs14_3A.Shot_Dist",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 140,
	pitch = {90, 110},
