...
SWEP.NPC_ReloadSound = {"Weapon_Shotgun.NPC_Reload"} -- Sounds it plays when the base detects the SNPC playing a reload animation
...
SWEP.Primary.Sound = {"weapons/spas12/fire1.wav","weapons/spas12/fire2.wav","weapons/spas12/fire3.wav","weapons/spas12/fire4.wav"}
SWEP.Primary.DistantSound = {"weapons/spas12/fire_dist1.wav","weapons/spas12/fire_dist2.wav","weapons/spas12/fire_dist3.wav","weapons/spas12/fire_dist4.wav"}
