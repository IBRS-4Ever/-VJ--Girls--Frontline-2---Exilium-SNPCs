...
SWEP.PrintName = "#weapon_vj_gf2_m1903"
SWEP.Category = "GF2"
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel = "models/weapons/w_springfield_m1903.mdl"
...
SWEP.NPC_HasSecondaryFire = false
	-- Primary Fire ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.Primary.Damage = GetConVarNumber("vj_gf2_m1903_d")
SWEP.Primary.Force = 1
SWEP.Primary.ClipSize = 5
SWEP.Primary.Ammo = "ar2"
SWEP.Primary.Sound = "GF2_SNPC.Weapon_M1903.Shot"
SWEP.Primary.DistantSound = "GF2_SNPC.Weapon_M1903.Shot_Dist"
...
sound.Add({
	name = "GF2_SNPC.Weapon_M1903.Shot_Dist",
	channel = CHAN_AUTO,
	volume = 1.0,
	level = 140,
	pitch = {90, 110},
