...
ENT.SoundTbl_GrenadeAttack = {SndPrefix.."grenade_attack1.wav",SndPrefix.."grenade_attack2.wav",SndPrefix.."grenade_attack3.wav",SndPrefix.."grenade_attack4.wav",SndPrefix.."grenade_attack5.wav",SndPrefix.."grenade_attack6.wav",SndPrefix.."grenade_attack7.wav"}
ENT.SoundTbl_Pain = {SndPrefix.."hit1.wav",SndPrefix.."hit2.wav",SndPrefix.."hit3.wav",SndPrefix.."hit4.wav",SndPrefix.."hit5.wav"}
