...
ENT.PrintName		= "Deichgraf's Missile"
ENT.Category		= "Projectiles"

if (CLIENT) then
	local Name = "Deichgraf's Grenade"
	local LangName = "obj_gf2_missile_grenade"
...
ENT.Model = "models/prop/gfl2_peritya_grenade.mdl"
...
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:Init()
	util.SpriteTrail( self, 0, Color( 255, 255, 255), false, 32, 0, 1, 1 / ( 15 + 1 ) * 0.5, "trails/laser" )
