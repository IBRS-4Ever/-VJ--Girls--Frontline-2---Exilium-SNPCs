...
ENT.PrintName		= "Vector's Incendiary Grenade"
ENT.Category		= "Projectiles"

if (CLIENT) then
	local Name = "Vector's Incendiary Grenade"
	local LangName = "obj_gf2_vector_incendiary_grenade"
...
ENT.Model = "models/prop/gfl2_vector_incendiary_grenade.mdl" -- The models it should spawn with | Picks a random one from the table
...
function ENT:CustomOnInitialize()
	util.SpriteTrail( self, 0, Color( 255, 200, 40 ), false, 32, 0, 5, 1 / ( 15 + 1 ) * 0.5, "trails/laser" )
