...
ENT.PrintName		= "Soppo's Grenade"
ENT.Category		= "Projectiles"

if (CLIENT) then
	local Name = "Soppo's Grenade"
	local LangName = "obj_gf2_soppo_grenade"
...
ENT.Model = "models/prop/gfl2_soppo_grenade.mdl" -- The models it should spawn with | Picks a random one from the table
