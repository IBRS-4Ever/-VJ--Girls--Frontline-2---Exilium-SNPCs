...
ENT.PrintName		= "Peritya's Grenade"
ENT.Author 			= "IBRS"
ENT.Contact 		= ""
ENT.Information		= "Peritya's Grenade"
ENT.Category		= "Projectiles"

if (CLIENT) then
	local Name = "Peritya's Grenade"
	local LangName = "obj_gf2_Peritya_grenade"
...
ENT.Model = {"models/prop/gfl2_peritya_grenade.mdl"} -- The models it should spawn with | Picks a random one from the table
...
function ENT:CustomOnInitialize()
	util.SpriteTrail( self, 0, Color( 245, 225, 25), false, 32, 0, 5, 1 / ( 15 + 1 ) * 0.5, "trails/laser" )
end
---------------------------------------------------------------------------------------------------------------------------------------------
