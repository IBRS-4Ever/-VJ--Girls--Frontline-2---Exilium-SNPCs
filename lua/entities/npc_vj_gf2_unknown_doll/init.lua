...
ENT.GrenadeAttackEntity = {"obj_gf2_unknown_doll_hack_grenade","obj_gf2_vepley_grenade","obj_gf2_klukai_grenade"}
...
function ENT:OnHalfHealth() 
	...
	if !GetConVar("vj_gf2_npc_unknown_doll_summon_dummy"):GetBool() then return end
	local Pos = self:GetPos()
	local Vepley = ents.Create("npc_vj_gf2_unknown_doll_dummy")
	...
	local Nemesis = ents.Create("npc_vj_gf2_unknown_doll_dummy")
	...
	local Colphne = ents.Create("npc_vj_gf2_unknown_doll_dummy")
	...
	local Charolic = ents.Create("npc_vj_gf2_unknown_doll_dummy")
...
function ENT:GF2_CustomOnThink_AiEnabled()
	if !GetConVar("vj_gf2_npc_unknown_doll_switch_weapons"):GetBool() then return end
