...
local CharacterName = "Colphne: "
local CharacterColor = Color(200,60,80,255)
...
local GF2Subtitle = { -- add new tables inside here
...

	{
		...
		subject = CharacterName,
		text = "The necessary tasks... have not been completed yet... I cannot stop here... absolutely not!",
		subjectcol = CharacterColor,
		lang = Language,
	},
...

	{
		...
		subject = CharacterName,
		text = "Hmm~ What are we goint to do today?",
		subjectcol = CharacterColor,
		lang = Language,
	},
...

	{
		...
		subject = CharacterName,
		text = "Hi, Commander, can I help you with anything? My schedule is currently blank~",
		subjectcol = CharacterColor,
		lang = Language,
	},
	--[[
	...
	--[[
	{
		...
		subject = CharacterName,
		text = "赢了？理所当然啦~人家可是不会手下留情的呢~没错，所有挡在我面前的...",
		subjectcol = CharacterColor,
		lang = Language,
	},
	]]--
