...
local GF2Subtitle = { -- add new tables inside here
...

	{
		...
		subject = CharacterName,
		text = {
			["schinese"] = "加班工作的深夜，很适合摄入高热量吧，吃一块蛋糕怎么样？放心，这次我有克制自己的创新欲望哦。", 
		},
		subjectcol = CharacterColor,
	},
...

	{
		...
		subject = CharacterName,
		text = {
			["schinese"] = "夜晚的时间，很适合专注于自己的事情，但是，和指挥官一起度过，也是不错的选择。", 
		},
		subjectcol = CharacterColor,
	},
...

	{
		...
		subject = CharacterName,
		text = {
			["schinese"] = "昨晚的温度是 4 摄氏度，对指挥官而言，应该属于寒冷的范畴，指挥官是否有做好保暖措施，新采购的围巾已经到了，就在指挥室，夜晚降温时，我会提醒您系上的。", 
		},
		subjectcol = CharacterColor,
	},
...

	{
		...
		subject = CharacterName,
		text = {
			["schinese"] = "能够被您所信赖，是我的荣幸，今后，也请继续依靠我吧，指挥官。", 
		},
		subjectcol = CharacterColor,
	},

	{
		...
		subject = CharacterName,
		text = {
			["schinese"] = "我...需要什么？指挥官不是一直都知道吗？从我加入指挥官的队伍开始，一直以来，我需要的，指挥官最终都会给我，现在，我只希望，这一刻的平静，能够一直持续下去。", 
		},
		subjectcol = CharacterColor,
	},
