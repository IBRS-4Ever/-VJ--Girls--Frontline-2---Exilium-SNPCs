...
local GF2Subtitle = { -- add new tables inside here
	...
	{
		snd = "vo/jp/sextans_paradeus/alert1.wav", 
	...
	{
		snd = "vo/jp/sextans_paradeus/alert2.wav", 
		subject = CharacterName, 
		text = { -- ID: 
			["schinese"] = "目标确认。", 
	...
	{
		snd = "vo/jp/sextans_paradeus/alert4.wav", 
		subject = CharacterName, 
		text = { -- ID: 
	...
	{
		snd = "vo/jp/sextans_paradeus/alert5.wav", 
		subject = CharacterName, 
		text = { -- ID: 
	...
	{
		snd = "vo/jp/sextans_paradeus/die1.wav", 
		subject = CharacterName, 
		text = { -- ID: 
	...
	{
		snd = "vo/jp/sextans_paradeus/killed_enemy1.wav", 
		subject = CharacterName, 
		text = { -- ID: 
			["schinese"] = "毫无用处。", 
	...
	{
		snd = "vo/jp/sextans_paradeus/killed_enemy2.wav", 
		subject = CharacterName, 
		text = { -- ID: 
	...
	{
		snd = "vo/jp/sextans_paradeus/killed_enemy3.wav", 
		subject = CharacterName, 
		text = { -- ID: 
