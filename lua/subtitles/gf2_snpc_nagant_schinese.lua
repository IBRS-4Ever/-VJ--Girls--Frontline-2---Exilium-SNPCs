...
local CharacterName = "纳甘："
local CharacterColor = Color(50,100,165,255)
...
local GF2Subtitle = { -- add new tables inside here
	...
	{
		snd = "vo/jp/nagant/get_heal1.wav",
		subject = CharacterName,
		text = "嗯...一般般吧。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/get_heal2.wav",
		subject = CharacterName,
		text = "还、还有吗？全都给我！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/get_heal3.wav",
		subject = CharacterName,
		text = "噢！还不错嘛！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/get_heal4.wav",
		subject = CharacterName,
		text = "还不够还不够！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/get_heal5.wav",
		subject = CharacterName,
		text = "现在，本天才是完全形态啦！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack1.wav",
		subject = CharacterName,
		text = "耶耶！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack2.wav",
		subject = CharacterName,
		text = "啧啧啧。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack3.wav",
		subject = CharacterName,
		text = "变成碎片吧！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack4.wav",
		subject = CharacterName,
		text = "看我看我！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack5.wav",
		subject = CharacterName,
		text = "笨蛋！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack6.wav",
		subject = CharacterName,
		text = "这里这里！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/grenade_attack7.wav",
		subject = CharacterName,
		text = "差不多行了！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/unfollow2.wav",
		subject = CharacterName,
		text = "真是的...",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/unfollow3.wav",
		subject = CharacterName,
		text = "啊？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/nagant/player_sight1.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight2.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight3.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight4.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight5.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight6.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight7.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight8.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight9.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight10.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight11.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight12.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/nagant/player_sight13.wav",
		subject = CharacterName,
