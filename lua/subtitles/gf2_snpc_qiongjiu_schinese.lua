...
local CharacterName = "琼玖："
local CharacterColor = Color(220,90,30,255)
...
local GF2Subtitle = { -- add new tables inside here
	...
	{
		snd = "vo/jp/qiongjiu/follow1.wav",
		subject = CharacterName,
		text = "嗯嗯。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/follow2.wav",
		subject = CharacterName,
		text = "哈！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/follow4.wav",
		subject = CharacterName,
		text = "你好，饲养员！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/follow5.wav",
		subject = CharacterName,
		text = "好好好。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/get_heal2.wav",
		subject = CharacterName,
		text = "还、还有吗？全都给我！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/get_heal3.wav",
		subject = CharacterName,
		text = "噢！还不错嘛！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/get_heal4.wav",
		subject = CharacterName,
		text = "还不够还不够！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/get_heal5.wav",
		subject = CharacterName,
		text = "现在，本天才是完全形态啦！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack1.wav",
		subject = CharacterName,
		text = "耶耶！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack2.wav",
		subject = CharacterName,
		text = "啧啧啧。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack3.wav",
		subject = CharacterName,
		text = "变成碎片吧！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack4.wav",
		subject = CharacterName,
		text = "看我看我！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack5.wav",
		subject = CharacterName,
		text = "笨蛋！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack6.wav",
		subject = CharacterName,
		text = "这里这里！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/grenade_attack7.wav",
		subject = CharacterName,
		text = "差不多行了！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/unfollow1.wav",
		subject = CharacterName,
		text = "唉？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/unfollow2.wav",
		subject = CharacterName,
		text = "真是的...",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/unfollow3.wav",
		subject = CharacterName,
		text = "啊？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/qiongjiu/player_sight1.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/qiongjiu/player_sight4.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/qiongjiu/player_sight7.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/qiongjiu/player_sight10.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/qiongjiu/player_sight12.wav",
		subject = CharacterName,
