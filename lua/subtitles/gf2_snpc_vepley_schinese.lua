...
local CharacterName = "维普蕾："
local CharacterColor = Color(210,155,70,255)
local Language = "schinese2"

local GF2Subtitle = { -- add new tables inside here
	
	{
		snd = "vo/jp/vepley/alert1.wav", 
	...
	{
		snd = "vo/jp/vepley/get_heal1.wav",
		subject = CharacterName,
		text = "嗯...一般般吧。",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/get_heal2.wav",
		subject = CharacterName,
		text = "还、还有吗？全都给我！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/get_heal3.wav",
		subject = CharacterName,
		text = "噢！还不错嘛！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/get_heal4.wav",
		subject = CharacterName,
		text = "还不够还不够！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/get_heal5.wav",
		subject = CharacterName,
		text = "现在，本天才是完全形态啦！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/grenade_attack5.wav",
		subject = CharacterName,
		text = "笨蛋！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/grenade_attack6.wav",
		subject = CharacterName,
		text = "这里这里！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/grenade_attack7.wav",
		subject = CharacterName,
		text = "差不多行了！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/killed_enemy1.wav",
		subject = CharacterName,
		text = "呀哈！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/killed_enemy2.wav",
		subject = CharacterName,
		text = "拜拜！",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/killed_enemy3.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/killed_enemy4.wav",
		subject = CharacterName,
		text = "哼！蜜罐做得到吗？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/unfollow1.wav",
		subject = CharacterName,
		text = "唉？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/unfollow3.wav",
		subject = CharacterName,
		text = "啊？",
		subjectcol = CharacterColor,
		lang = Language,
	...
	{
		snd = "vo/jp/vepley/player_sight3.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight4.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight5.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight6.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight7.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight8.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight9.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight10.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight11.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight12.wav",
		subject = CharacterName,
	...
	{
		snd = "vo/jp/vepley/player_sight13.wav",
		subject = CharacterName,
